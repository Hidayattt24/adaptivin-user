        ...
        <div className="w-full max-w-md mx-auto">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 backdrop-blur-sm border border-white/50">
              ...
              <div className="text-center mb-6">
                ...
                />
                <h1 className="poppins-bold text-2xl mb-2" style={{ color: '#1C6EA4' }}>
                  Masuk Sebagai Siswa
                </h1>
                ...
                <div>
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <svg className="h-5 w-5" style={{ color: '#1C6EA4' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex items-center">
                  <label className="flex items-center cursor-pointer">
                    <input
                      ...
                      disabled={isLoading}
                    />
                    <span className="ml-2 text-sm text-gray-600 poppins-regular">Ingat saya</span>
                  </label>
                </div>
