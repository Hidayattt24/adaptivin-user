...
Pengurangan adalah operasi matematika yang mengurangi suatu bilangan dengan bilangan lainnya.`,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Redirect ke preview materi
    router.push(`/guru/kelas/${kelasId}/materi/${materiId}`);
  };
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-600 mb-4">
        ...
        <span>/</span>
        <Link
          href={`/guru/kelas/${kelasId}/materi/${materiId}`}
          className="hover:text-blue-600"
        >
          {formData.judul}
        </Link>
      ...
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Edit Materi</h1>
        <p className="text-gray-600">
          Perbarui informasi dan konten materi pembelajaran
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end gap-4">
          <Link href={`/guru/kelas/${kelasId}/materi/${materiId}`}>
            <button
              type="button"
