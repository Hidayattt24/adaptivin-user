  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-md border border-gray-100 transition-all duration-300 hover:shadow-lg">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-start justify-between gap-3 sm:gap-4 mb-4 sm:mb-5 lg:mb-6">
        ...
        {/* Status Indicator */}
        <div
          className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg sm:rounded-xl poppins-semibold text-xs sm:text-sm whitespace-nowrap flex-shrink-0 ${isCompleted
              ...
              <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl sm:rounded-2xl shadow-2xl border-2 border-[#336d82]/20 max-h-[200px] sm:max-h-[240px] overflow-y-auto z-50">
                {allMaterials.map((mat) => (
                  <button
                    ...
                    className={`w-full px-4 sm:px-5 py-3 sm:py-4 text-left hover:bg-[#336d82]/5 active:bg-[#336d82]/10 transition-all duration-150 first:rounded-t-xl first:sm:rounded-t-2xl last:rounded-b-xl last:sm:rounded-b-2xl border-b border-gray-100 last:border-b-0 ${selectedMateri.materiId === mat.materiId
                  ...
                  >
                    <div className="flex justify-between items-center gap-2">
                      ...
                      <span
                        className={`text-[10px] sm:text-xs px-2 py-1 rounded-lg poppins-semibold flex-shrink-0 ${mat.status === "completed"
